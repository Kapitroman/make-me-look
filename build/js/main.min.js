...
/* harmony import */ var _modules_scroll_sections__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/scroll-sections */ "./js/modules/scroll-sections.js");
/* harmony import */ var _modules_init_clothes_models_slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-clothes-models-slider */ "./js/modules/init-clothes-models-slider.js");
/* harmony import */ var _modules_choose_look__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/choose-look */ "./js/modules/choose-look.js");
/* harmony import */ var _modules_move_next_section__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/move-next-section */ "./js/modules/move-next-section.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    // moveToSection();
    // init();
    Object(_modules_scroll_sections__WEBPACK_IMPORTED_MODULE_2__["scrollSections"])();
    Object(_modules_init_clothes_models_slider__WEBPACK_IMPORTED_MODULE_3__["initClothesModelsSlider"])();
    Object(_modules_choose_look__WEBPACK_IMPORTED_MODULE_4__["chooseLook"])();
    Object(_modules_move_next_section__WEBPACK_IMPORTED_MODULE_5__["moveNextsection"])();
  });
});
...
/***/ "./js/modules/choose-look.js":
/*!***********************************!*\
  !*** ./js/modules/choose-look.js ***!
  \***********************************/
/*! exports provided: chooseLook */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "chooseLook", function() { return chooseLook; });
var chooseLook = function chooseLook() {
  var viewer = document.querySelector('.al-assistant__viewer');
  if (!viewer) {
    return;
  }
  var pictures = viewer.querySelectorAll('.al-assistant__model');
  var controllButtons = viewer.querySelector('.al-assistant__viewer-buttons-container');
  var controllRadios = viewer.querySelector('.al-assistant__viewer-radio-container');
  var pictureButtons = viewer.querySelectorAll('.al-assistant__viewer-button');
  var radioButtons = viewer.querySelectorAll('.al-assistant__viewer-radio-container input');
  var links = viewer.querySelectorAll('.al-assistant__viewer-links-container img');
  radioButtons[1].setAttribute('checked', true);
  radioButtons[1].checked = true;
  console.log(radioButtons);
  console.log(radioButtons[1]);
  var clickPictureButtonHandler = function clickPictureButtonHandler(evt) {
    evt.preventDefault();
    ...
    radioButtons.forEach(function (item) {
      return item.removeAttribute('checked');
    });
  ...
  var changeRadioButtonHandler = function changeRadioButtonHandler(evt) {
    var target = evt.target.closest('label').querySelector('input');
    var index = target.getAttribute('data-radio-index');
    pictures.forEach(function (item) {
      return item.classList.remove('is-active');
    });
    radioButtons.forEach(function (item) {
...
/***/ "./js/modules/init-clothes-models-slider.js":
/*!**************************************************!*\
  !*** ./js/modules/init-clothes-models-slider.js ***!
  \**************************************************/
/*! exports provided: initClothesModelsSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initClothesModelsSlider", function() { return initClothesModelsSlider; });
/* harmony import */ var _matchMedia__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./matchMedia */ "./js/modules/matchMedia.js");

var clothesItemShowContainer = document.querySelector('.clothes-item-show');
var swiper, swiper2, swiper3;
var initLandscapeSwiper = function initLandscapeSwiper(slider, slider2) {
  ...
  var slideChange = function slideChange() {
    var activeSlide = swiper.realIndex;
    swiper2.slideTo(activeSlide);
  };
  var slideChange2 = function slideChange2() {
    var activeSlide = swiper2.realIndex;
    swiper.slideTo(activeSlide);
  };
  swiper.on('slideChange', slideChange);
  swiper2.on('slideChange', slideChange2);
};
var initPortraitSwiper = function initPortraitSwiper(slider3) {
...
var initClothesModelsSlider = function initClothesModelsSlider() {
  if (!clothesItemShowContainer) {
    return;
  }
  var clothesSlider = clothesItemShowContainer.querySelector('.clothes-item-show__slider-items');
  var modelsSlider = clothesItemShowContainer.querySelector('.clothes-item-show__slider-models');
  _matchMedia__WEBPACK_IMPORTED_MODULE_0__["matchMedia"].add('(orientation: landscape)', function () {
    if (swiper3) {
      swiper3.destroy(true, true);
    }
    initLandscapeSwiper(clothesSlider, modelsSlider);
  });
  _matchMedia__WEBPACK_IMPORTED_MODULE_0__["matchMedia"].add('(orientation: portrait)', function () {
    if (swiper) {
...
/***/ "./js/modules/move-next-section.js":
/*!*****************************************!*\
  !*** ./js/modules/move-next-section.js ***!
  \*****************************************/
/*! exports provided: moveNextsection */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "moveNextsection", function() { return moveNextsection; });
var moveNextsection = function moveNextsection() {
  var button = document.querySelector('.hero__button-next');
  if (!button) {
    return;
  }
  var moveTo = function moveTo(evt) {
    evt.defaultPrevented;
    gsap.to(window, {
      duration: 1,
      scrollTo: {
        y: document.documentElement.clientWidth * 7 / 6
      }
    });
  };
...
var scrollSections = function scrollSections() {
  ...
  var translateSection = function translateSection() {
    _matchMedia__WEBPACK_IMPORTED_MODULE_0__["matchMedia"].add('(orientation: landscape)', function () {
      gsap.to(container, {
        x: function x() {
  ...
  var moveToSection = function moveToSection() {
    Array.from(document.querySelectorAll('.header__link')).forEach(function (item, index) {
      item.addEventListener('click', function (evt) {
        ...
        _matchMedia__WEBPACK_IMPORTED_MODULE_0__["matchMedia"].add('(orientation: landscape)', function () {
          gsap.to(window, {
            duration: 3,
            scrollTo: {
              y: document.documentElement.clientWidth * 7 / 6 * (index + 1)
            }
          });
        });
        _matchMedia__WEBPACK_IMPORTED_MODULE_0__["matchMedia"].add('(orientation: portrait)', function () {
  ...
  var addHeaderClass = function addHeaderClass() {
    ...
    var addLastSectionHandler = function addLastSectionHandler() {
