...
/* harmony import */ var _modules_get_match_media__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/get-match-media */ "./js/modules/get-match-media.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    //scrollSections();
    Object(_modules_get_match_media__WEBPACK_IMPORTED_MODULE_5__["getMatchMedia"])();
    var burger = new _modules_burger__WEBPACK_IMPORTED_MODULE_6__["Burger"]();
    burger.init();
  });
});
...
/***/ "./js/modules/add-header-shadow.js":
/*!*****************************************!*\
  !*** ./js/modules/add-header-shadow.js ***!
  \*****************************************/
/*! exports provided: addHeaderShadow */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addHeaderShadow", function() { return addHeaderShadow; });
...
/***/ "./js/modules/get-match-media.js":
/*!***************************************!*\
  !*** ./js/modules/get-match-media.js ***!
  \***************************************/
/*! exports provided: getMatchMedia */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMatchMedia", function() { return getMatchMedia; });
/* harmony import */ var _scroll_sections__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scroll-sections */ "./js/modules/scroll-sections.js");
/* harmony import */ var _add_header_shadow__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-header-shadow */ "./js/modules/add-header-shadow.js");


var getMatchMedia = function getMatchMedia() {
  var matchMedia = gsap.matchMedia();
  matchMedia.add('(orientation: landscape)', function () {
    Object(_scroll_sections__WEBPACK_IMPORTED_MODULE_0__["scrollSections"])();
    window.removeEventListener('scroll', _add_header_shadow__WEBPACK_IMPORTED_MODULE_1__["addHeaderShadow"]);
  });
  matchMedia.add('(orientation: portrait)', function () {
    window.addEventListener('scroll', _add_header_shadow__WEBPACK_IMPORTED_MODULE_1__["addHeaderShadow"]);
  });
};
